//
// ipc-distance-type.h 鈥?shared (C++ + HLSL) IPC distance-type classification.
//
...
//
// Include path:
//   C++  : #include <Contact/shared/ipc-distance-type.h>   (FEM/include on path)
//   HLSL : #include <Contact/shared/ipc-distance-type.h>   (add FEM/include via -I)
//
