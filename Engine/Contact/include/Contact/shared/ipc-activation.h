//
// ipc-activation.h 鈥?shared (C++ + HLSL) candidate -> active-constraint mapping.
//
...
#include <Contact/shared/ipc-distance-type.h>
...
#define SH_CK_PT   2
#define SH_CK_EE   3
#define SH_CK_NONE 4  // inactive / unclassified 鈥?never emitted
