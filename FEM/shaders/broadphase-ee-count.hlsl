// ============================================================================
// broadphase-ee-count.hlsl — EE broad phase, pass 1 (count).
// One thread per query edge. Traverse the edge LBVH; for each leaf edge whose
// raw trajectory AABB overlaps the query edge's dHat-dilated AABB and is NOT
// adjacent (shares no vertex), count a candidate. Mirrors CPU
// computeEdgeEdgeCollisionPairs (no i<j dedup — each edge queries all edges).
// ============================================================================
